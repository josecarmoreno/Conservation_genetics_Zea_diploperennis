...
./BA3SNP -i10000000 -b1000000 -v ~/Documentos/Z_diploperennis/data/dataset1diploperennis_data_d1_k2.ba3 
...
./BA3SNP -i10000000 -b1000000 -a0.20 -f0.05 -v ~/Documentos/Z_diploperennis/data/dataset1diploperennis_data_d1_k2.ba3
