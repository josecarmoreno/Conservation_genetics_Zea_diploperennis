### This script will perform the inference for the model three_epoch in the population Nayarit
...
# Output file path
output_path = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Nayarit_threeepoch_fits.txt'
