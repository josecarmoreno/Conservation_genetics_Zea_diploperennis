### This script performs an uncertainty analysis with a Godambe Information Matrix using the software dadi
...
boots_fids = glob.glob('/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/SFS/Nayarit_boot/Nayarit.boot_*.fs')
...
popt = [0.00282, 0.01297]  # [nu, T]

## Create the output file and define the path
output_file = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Nayarit_twoepoch_uncertainty.txt'
