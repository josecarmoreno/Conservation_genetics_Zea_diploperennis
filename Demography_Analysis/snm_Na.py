### This script will evaluate the Standard Neutral Model (snm_1d) for the population Nayarit
...
## Output path
output_path = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Nayarit_snm_fit.txt'
