### This script will perform the inference for the model three_epoch in the population Jalisco
...
# Define the three_epoch model
demo_model = dadi.Demographics1D.three_epoch
demo_model_ex = dadi.Numerics.make_extrap_func(demo_model)

# Define parameter bounds: (nuB, nuF, TB, TF)
lower_bounds = [1e-4, 1e-4, 1e-3, 1e-3]
upper_bounds = [10, 10, 10, 10]

# Initial parameters (reasonable guesses)
params = [0.5, 1.5, 0.2, 0.1]

# Output file path
output_path = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Jalisco_threeepoch_fits.txt'
fid = open(output_path, 'w')

# Write headers
header = ['log_likelihood', 'nuB', 'nuF', 'TB', 'TF', 'theta']
...
for ronda_idx, n_iter in enumerate(rondas):
    ...
    # Use best params for next round
