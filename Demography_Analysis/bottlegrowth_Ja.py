### This script will perform the inference for the model bottlegrowth in the population Jalisco
...
## Output file
output_path = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Jalisco_bottlegrowth_fits.txt'
