...
popt = [0.00112, 0.1, 0.00583]  # ejemplo: [nuB, nuF, T]

## Create the output file and define the path

output_file = '/home/jose-carlos-moreno-juarez/Documentos/Z_diploperennis/out/dadi/demographic_models/Nayarit_bottlegrowth_uncertainty.txt'
